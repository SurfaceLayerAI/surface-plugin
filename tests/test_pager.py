...
class TestFormatRow:
    def test_short_summary_single_line(self):
        ...
        lines = format_row("sess-abc-123", "Yes", "No", "Short summary", 40)
        assert len(lines) == 1
